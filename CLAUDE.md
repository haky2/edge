...
### 관심종목 — 앱 로컬 DB가 정본 (2026-07-25~)
관심종목은 각 기기의 로컬 DB(SQLDelight)에 있고, 앱이 `POST /watchlist/sync`로 백엔드에 올린다.
**슬랙 신호·주간회고**는 등록된 활성 기기(30일 내 sync)의 **합집합**을 스캔한다(등록 0이면 폴백 삼성전자 1종목).
아래 구 11종목(2026-06-03)은 더 이상 신호 기준이 아니다 — 참고용 이력으로만 남긴다.
> 구 목록: 018260·329180·066570·307950·000660·005930·267260·001440·062040·047810·012450

**검증·백테스트 레퍼런스**(`REFERENCE_CODES`, "내 관심종목"과 분리된 고정 시장 표본, 섹터 대표 14종):
반도체 005930 · 2차전지 006400 · 인터넷 035420 · 자동차 005380 · 바이오 207940 · 금융 105560 ·
철강 005490 · 조선 329180 · 방산 012450 · 통신 017670 · 유틸 015760 · 소비재 033780 · 화학 051910 · 건설 000720.
...
- **프롬프트 신규 조항 전 기본 질문 — 조항 수를 늘리지 않고(기존 조항 수정·facts 개선으로) 해결할 수 없나.** 조항은 추가는 쉽고 제거는 실측 A/B가 필요해 비대칭적으로 쌓인다. 같은 실측을 두 조항에 쓰게 되면 한쪽을 정본으로 두고 조항 이름으로 위임(번호 참조 금지) — `docs/prompt-diet-2026.md` 참고.
