...
category 규칙:
- "호재": 이벤트 자체의 방향이 이미 긍정으로 정해진 것만 (예: 확정된 부양책 시행, 지수 편입 확정)
- "주의": 결과에 따라 주가가 어느 쪽으로든 크게 흔들릴 수 있는 양방향 이벤트 (CPI·PPI·고용 등 지표 발표, 금리 결정, 무역협상). 지표 "발표"는 결과를 모르므로 호재가 아니라 주의다.
