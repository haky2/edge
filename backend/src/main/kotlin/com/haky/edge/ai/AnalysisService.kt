...
class AnalysisService(
    ...
    companion object {
        ...
        private val COMMON_RULES = """
            ...
            C6. 뉴스는 종목과 무관한 것이 섞일 수 있다. 관련 있어 보이는 것만 쓰고 억지로 연결하지 마라. 뉴스마다 날짜가 붙어 있다 — 3일 이상 지난 기사를 오늘의 재료처럼 서술하지 말고 "지난 ~일 보도된" 식으로 시점을 구분하라. 유사 기사는 한 건으로 묶여 있고 "(유사 외 N건)"은 같은 이슈가 그만큼 쏟아졌다는 관심도 신호다. 요약 줄이 없는 항목은 제목만 제공된 것이니 제목 범위에서만 써라.
