    ...
    companion object {
        ...
        val DEEP_RESEARCH_PROMPT = """
            ...
            D6. 형식: 응답 첫 글자부터 "### 핵심 요약" 소제목, 그 아래 2~3문장(가장 중요한 신규 정보 중심,
                ...
                (예: **업계·경쟁 구도**, **수주·파이프라인**, **해외 동종업체**, **리스크 요인**).
                소제목과 본문 사이, 단락과 단락 사이는 빈 줄 하나(\n\n) — 소제목 줄은 반드시 단독
                문단이어야 한다(앱 카드가 이 형식으로 섹션을 나눈다). 불릿·번호 목록·구분선 금지.
            ...
            ④ 면책·주의 문구("매매 권유 아님"류)와 내부 용어("1층/2층")를 본문에 쓰지 않았는가 —
            마지막 문단이 이런 마무리 문구면 그 문단을 통째로 삭제하라.
        """.trimIndent()
    }
}
